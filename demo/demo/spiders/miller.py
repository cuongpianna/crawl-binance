...
class IMDBSpider(Spider):
    name = 'MillerSpider'
    urls = ['https://www.millerwelds.com/equipment/welders/mig-gmaw',
            ...
            'https://www.millerwelds.com/equipment/welders/multioperator',
            'https://www.millerwelds.com/products/subarc-overview']
    start_requests = []
    base_url = 'https://www.millerwelds.com/'
    ...
    def parse_images(self, response):
        ...
        if not os.path.exists(path):
            os.makedirs(path)
        images = response.xpath('//div[@class="thumbs"]//li[@style="display: list-item;"]//img/@src').extract()
        images = set(images)
        result = []
        for img in images:
            if img:
